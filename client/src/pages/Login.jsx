  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            <h1 style={{ margin: "18px 0 10px", fontSize: "28px", lineHeight: "1.2" }}>
              Anticipate trends with clarity.
            </h1>
            <p style={{ margin: 0, color: palette.muted, maxWidth: "380px" }}>
              Access predictions, monitor signals, and act with confidence using real-time analytics.
            </p>
          </div>
          ...
          >
            {[
              { label: "Forecast accuracy", value: "94.3%" },
        ...
        >
          <div>
            <h2 style={{ margin: 0, marginBottom: "6px", fontSize: "24px" }}>Welcome back</h2>
          ...
          >
            ...
            />
            Secure login • Encrypted transit • Session protected
          </div>
        </div>
      </div>
